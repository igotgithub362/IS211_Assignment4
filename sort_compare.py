...
def main():
	...
	print ("Sequential Search took %10.7f seconds, to run over a list of length 500" % sq_average_500)
	print ("Sequential Search took %10.7f seconds, to run over a list of length 1000" % sq_average_1k)
	print ("Sequential Search took %10.7f seconds, to run over a list of length 10000" % sq_average_10k)
	print ("\n")
	print ("Ordered Sequential Search took %10.7f seconds, to run over a list of length 500" % osq_average_500)
	print ("Ordered Sequential Search took %10.7f seconds, to run over a list of length 1000" % osq_average_1k)
	print ("Ordered Sequential Search took %10.7f seconds, to run over a list of length 10000" % osq_average_10k)
	print ("\n")
	print ("Binary Search Iterative took %10.7f seconds, to run over a list of length 500" % bsi_average_500)
	print ("Binary Search Iterative took %10.7f seconds, to run over a list of length 1000" % bsi_average_1k)
	print ("Binary Search Iterative took %10.7f seconds, to run over a list of length 10000" % bsi_average_10k)
	print ("\n")
	print ("Binary Search Recursive took %10.7f seconds, to run over a list of length 500" % bsr_average_500)
	print ("Binary Search Recursive took %10.7f seconds, to run over a list of length 1000" % bsr_average_1k)
	print ("Binary Search Recursive took %10.7f seconds, to run over a list of length 10000" % bsr_average_10k)
